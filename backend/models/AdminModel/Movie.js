...
module.exports = mongoose.model('MovieAdmin', movieSchema);
...
module.exports = mongoose.model('ReviewAdmin', reviewSchema);
...
module.exports = mongoose.model('BookingAdmin', bookingSchema);
...
module.exports = mongoose.model('ShiftAdmin', shiftSchema);
...
module.exports = mongoose.model('InquiryAdmin', inquirySchema);
...
module.exports = mongoose.model('ShowAdmin', ShowSchema);
...
module.exports = mongoose.model('AdminAdmin', adminSchema);
...
module.exports = mongoose.model('EmployeeAdmin', EmployeeSchema);
