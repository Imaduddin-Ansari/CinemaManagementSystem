...
export const ReportsPage = () => {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        const response = await axios.get('http://cinema-backend:3000/api/reports');
  ...
  const handleGenerateReport = async () => {
    try {
      const response = await axios.post('http://cinema-backend:3000/api/reports/generate', { type: reportType });
  ...
  const handleViewReport = async (reportId) => {
    try {
      const response = await axios.get(`http://cinema-backend:3000/api/reports/${reportId}`);
  ...
  const handleDeleteReport = async (reportId) => {
    try {
      const response = await axios.delete(`http://cinema-backend:3000/api/reports/${reportId}`);
